...
[hREA](hrea.io) - Implementação do modelo REA(Recursos, Eventos, Agentes) em Holochain. Permitindo soluções mais gerais, indo além de contabilizar apenas atividades financeiras, sem necessitar de infraestruturas centralizadas. Atualmente participo de um grupo de testes para um aplicativo de Requests & Offers

[Free Forum](https://www.freefreeforum.org/) - Grupo de Tulsa, que veio representado por Clara Mattei participar do festival de ideias da Unicamp. As soluções propostas por eles incluem mecanismos de reputação, créditos locais, ... tudo implementado via protocolo [Hypha](https://hypha.earth/), sobre a blockchain [Base](https://www.base.org/)
